...
class UserDataPageGet {
  List ids = [
    '1235888', '11222', '1352', '188', '1111', '1234', '2336',
    '256889', '166161', '12333333', '8183084562', '1212', '1156',
    '666666', '1111', '6666', '13623', '494646', '122', '233131',
    '1888', '156', '157', '158', '159', '160', '155', '123',
    '150', '151', '152', '153', '154', '131', '132', '133', '134', '139',
  ];

  Future<List<UserData>> listUserData() async {
    List<UserData> userData = [];
    for (int i = 0; i < ids.length; i++) {
      final List<XUserInfo> profileData =
